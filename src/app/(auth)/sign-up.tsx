...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, Pressable, Image, StatusBar, ActivityIndicator, ScrollView, KeyboardAvoidingView, Platform } from 'react-native';
